...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    JTextField tfname, tffname, tfaddress, tfphone,  tfemail, tfsalary, tfdesignation, tfempId;
    JDateChooser dcdob;
    ...
    public AddEmployee() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                cbDepartment.addItem(new Department(id, name));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        // Use a JTextField so the emp id can be changed
...
//            String aadhar = tfaadhar.getText();
            ...
            try {
                Conn conn = new Conn();
                String query = "insert into employee(name, fname, dob, salary, address, phone, email, education, designation,  empId, deptId) " +
                        "values('" + name + "', '" + fname + "', '" + dob + "', '" + salary + "', '" + address + "', '" + phone + "', '" + email + "', '" + education + "', '" + designation + "',  '" + empId + "', '" + deptId + "')";
